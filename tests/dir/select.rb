...
# Dir#select
d001 = "/tmp/sp_dir_select_1"
Dir.mkdir(d001) unless Dir.exist?(d001)
File.write("#{d001}/a", "")

# Dir includes Enumerable in Ruby, so #select works on a Dir instance. Spinel refuses
...
h001 = Dir.new(d001)
r001 = (h001.select { |e| e == "a" } rescue $!.class); p r001
h001.close
#
h002 = Dir.new(d001)
r002 = (h002.select { |e| e.length > 1 } rescue $!.class); p r002
h002.close
