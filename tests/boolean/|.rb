...
# Integer argument: Spinel does a numeric bitwise-OR instead of logical |
p(false | 0)
...
p([false, false, true].reduce { |x021, y021| x021 | y021 })
d021 = [false, false, false]
